...
const filter_method = strings.filter(function(str){
    return str.length >= 5 ;
})

console.log(filter_method)

//Challenge 2: Given an array of numbers, write a code to return a new array of map_method for each item in an array using map method.
const numbers = ['45', '55', '65', '75', '85'];

const map_method = numbers.map(function(item1){
    return item1 * item1;
})
...
const reduc_method = alphabets.reduce(function(ans,item2){
    return ans + item2;
})

console.log(reduc_method);

//Challenge 4: Given an array of numbers, write a code to return a first even number using find method.

const number = [1, 2, 3, 4, 5];

const find_method = number.find(function(number){
    return number % 2 === 0
});
...
const find_index_method = ranks.findIndex(function(seven){
  return seven === 7
});

console.log(find_index_method)
...
const for_each_method = num.forEach(function(item,index){
...
const some_method = marks.some(function(item){
  return item > 45;
});
...
const every_method = positive.every(function(item){
  return item > 0 ;
})
